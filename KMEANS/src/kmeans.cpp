...
// randomly initialize k cluster_center
...
// initialize clusters for every class using the first data in the class
...
int main () {
    ...
    km->init_clusters();
    performance = km->test();
    printf("Tested performance @ K = %d : %.2f", best_k, performance);
